...
import com.fadjarfirdaus.picodiploma.dicoding.submission4cataloguemovie.modelview.ModelViewNowplaying;
...
public class NowPlayingFragment extends Fragment {
    @BindView(R.id.rv_nowPlaying)RecyclerView recyclerView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ModelViewNowplaying model = ViewModelProviders.of(this).get(ModelViewNowplaying.class);
