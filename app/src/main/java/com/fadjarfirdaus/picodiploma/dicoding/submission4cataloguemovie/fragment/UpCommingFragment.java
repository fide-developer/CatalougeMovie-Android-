...
import com.fadjarfirdaus.picodiploma.dicoding.submission4cataloguemovie.modelview.ModelViewUpcomming;
...
public class UpCommingFragment extends Fragment {
    ...
    @BindView(R.id.rv_upComming)RecyclerView recyclerView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ModelViewUpcomming model = ViewModelProviders.of(this).get(ModelViewUpcomming.class);
        model.getMovie(getResources().getString(R.string.lang)).observe(this, new Observer<ArrayList<Model_Movie>>() {
            @Override
